function navRender() {
    ...
    tag({ tag: "a", className: "recipesLink", parent: recipes, href: "#recipes/list", html: "Рецепты" });
    ...
    tag({ tag: "a", className: "crLink", parent: categorRecipes, href: "#categorRecipes/list", html: "Категории рецептов" })
}
